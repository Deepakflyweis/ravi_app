...
class TermsnCond extends StatefulWidget {
  const TermsnCond({Key? key}) : super(key: key);

  @override
  State<TermsnCond> createState() => _TermsnCondState();
}

class _TermsnCondState extends State<TermsnCond> {
  @override
          ...
          body: SingleChildScrollView(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  SizedBox(height: 5.h,),
                  Text('Terms and Conditions',style: TxtStylebold,),
